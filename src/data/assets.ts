...
export const PAGE_ASSETS: Record<string, AssetKey> = {
  ...
  faq: 'shot5',
  'moonlighter-2-best-weapon': 'shot4',
  'moonlighter-2-infinite-endless-vault-guide': 'hero',
  'moonlighter-2-hardcore-mode': 'shot2',
  'moonlighter-2-shop-level-5': 'shot5',
  'moonlighter-2-endless-weapon-aspects': 'shot4',
  'moonlighter-2-bomb-path': 'shot3',
  'moonlighter-2-relic-loot-guide': 'shot3',
  'moonlighter-2-dungeon-extraction-guide': 'hero',
  'moonlighter-2-boss-completion-guide': 'shot2',
  'moonlighter-2-postgame-guide': 'shot5',
  about: 'header',
  contact: 'shot2',
